...
export const requiredEnvs = envalid.cleanEnv<EnvModel>(
	process.env,
	{
		AWS_NODEJS_CONNECTION_REUSE_ENABLED: envalid.num({ devDefault: 1 }),
		LOG_LEVEL: str({ default: "debug" }),
		GITHUB_OAUTH_TOKEN_SSM_PARAM: str({
			default: "/dev-pr-bot/slack-bot-token",
		}),
